...
# model constants
MODEL_PATH = '/storage/transfer_irony/'
MODEL_NAME = 'transfer_irony'
...
seqs = load_array(DATA_PATH + 'irony_seqs.hdf5', 'irony_seqs')
...
labels = load_array(DATA_PATH + 'irony/irony_labels.hdf5', 'irony_labels')
