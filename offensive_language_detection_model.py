...
# model constants
MODEL_PATH = '/storage/transfer_offlang/'
MODEL_NAME = 'transfer_offlang'
...
seqs = load_array(DATA_PATH + 'offlang_seqs.hdf5', 'offlang_seqs')
...
labels = load_array(DATA_PATH + 'offensive_lang/offlang_labels.hdf5', 'offlang_labels')
